      ...
      <main>
        <header className="bg-white dark:bg-gray-900">
          ...
          >
            ...
            <div
              // className="[isOpen ? 'translate-x-0 ' : 'opacity-0 -translate-x-full'] opacity-100"
          ...
          <div className="container mx-auto px-6 pt-28">
            ...
            <section className="mt-8 grid grid-cols-1 gap-8 lg:grid-cols-2 xl:mt-12 xl:grid-cols-3">
              ...
              <div className="rounded-lg border border-transparent bg-blue-500 p-8 dark:bg-blue-600">
                <p className="leading-loose text-white">“ตัดโหด”.</p>
        ...
        <footer className="bg-white pt-28 dark:bg-gray-900">
